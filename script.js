...
function startMaze() {
    ...
    const existingWalls = document.querySelectorAll('.maze-wall');
    existingWalls.forEach(wall => wall.remove());
    
    // Initialize player position
    mazePlayer.style.top = '50px';
    mazePlayer.style.left = '50px';
    ...
    const walls = [
        ...
        { top: 'calc(100% - 10px)', left: 0, width: '100%', height: '10px' },
        { top: 0, left: 'calc(100% - 10px)', width: '10px', height: '100%' },
        
        // Inner walls
        { top: '100px', left: '100px', width: '300px', height: '10px' },
        { top: '100px', left: '100px', width: '10px', height: '200px' },
        { top: '300px', left: '200px', width: '300px', height: '10px' },
        { top: '200px', left: '500px', width: '10px', height: '200px' },
        { top: '500px', left: '100px', width: '400px', height: '10px' }
    ];
